...
ds --hostfile=hostfile.txt --master_addr 172.19.12.84 --master_port 50001 ${dir}/../../pretrain_iFlytekSpark.py ${megatron_options} ${data_options} ${deepspeed_options} &>> ${log_path}/${jobname}_${host}_${current_time}.log
